            ...
            \begin{enumerate}
                ...
                \item {
                    ...
                    \begin{align*}
                        ...
                        &\implies y^{3}\frac{-1}{t^{3}} + y - \frac{3}{t}  = 0
                    \end{align*}
                    Que está en la forma de una ecuación cúbica deprimida que, 
                    por la fórmula de Cardano, tiene solución real
                    \begin{align*}
                        y &= \sqrt[3]{-\frac{-3t^{-1}}{2} + \sqrt{\frac{(-3t^{-1})^{2}}{4} 
                    + \frac{1^{3}}{27}}} + \sqrt[3]{-\frac{-3t^{-1}}{2} - \sqrt{\frac{(-3t^{-1})^{2}}{4} 
                    - \frac{1^{3}}{27}}} \\
                    y &= \sqrt[3]{\frac{3}{2t} + \sqrt{\frac{9}{4t^{2}} 
                    + \frac{1}{27}}} + \sqrt[3]{\frac{3}{2t} - \sqrt{\frac{9}{4t^{2}} 
                    + \frac{1}{27}}}
                    \end{align*}
                }
            \end{enumerate}
